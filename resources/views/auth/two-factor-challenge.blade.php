    ...
    <x-jet-authentication-card>
        ...
        <div x-data="{ recovery: false }">
            <div class="mb-4 text-sm text-gray-600" x-show="! recovery">
                {{ __('Konfirmasi akses ke akunmu dengan memasukan kode authentication provided dengan aplikasi authentication.') }}
            </div>

            <div class="mb-4 text-sm text-gray-600" x-show="recovery">
                {{ __('Konfirmasi akses ke akunmu dengan memasukan kode recovery') }}
            </div>
