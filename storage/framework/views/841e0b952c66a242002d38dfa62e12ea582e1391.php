...
} elseif ($_instance->childHasBeenRendered('nx4Rjse')) {
    $componentId = $_instance->getRenderedChildComponentId('nx4Rjse');
    $componentTag = $_instance->getRenderedChildComponentTagName('nx4Rjse');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nx4Rjse');
} else {
    $response = \Livewire\Livewire::mount('content');
    $html = $response->html();
    $_instance->logRenderedChild('nx4Rjse', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div><?php /**PATH E:\masakanku\resources\views/livewire/search.blade.php ENDPATH**/ ?>