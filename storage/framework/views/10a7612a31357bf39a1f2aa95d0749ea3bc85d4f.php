        ...
        <div class="px-4 py-3 sm:px-8 md:px-16">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-4 gap-3">
                <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('recipe-categorized', ['category'=>$c])); ?>" class="bg-teal-400 px-4 py-2 rounded-md hover:bg-teal-500 shadow-md transform hover:scale-105 transition ease-out duration-300 font-nunito font-semibold text-white text-center"><?php echo e($c); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <div class="flex items-center justify-center text-teal-700 text-xl font-semibold font-lora my-1">Or</div>
            <div class="flex justify-around items-center">
                <a href="<?php echo e(route('store-recipe')); ?>" class="bg-teal-500 px-4 py-2 rounded-md hover:bg-teal-400 shadow-md transform hover:scale-105 transition ease-out duration-300 font-nunito font-semibold text-white text-center">Buat Resepmu</a>
            </div>
        </div>
    </div>
...
<?php /**PATH E:\masakanku\resources\views/livewire/content.blade.php ENDPATH**/ ?>