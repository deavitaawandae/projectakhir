<div>
    ...
    <div class="bg-gray-100 shadow-md">
        <div class="px-4 py-3 sm:px-8 md:px-16">
            <div class="flex items-center justify-center text-teal-700 text-xl font-semibold font-lora mb-2">Total Resep (<?php echo e($recipe->count()); ?>)</div>
            <div class="flex justify-around items-center">
                <a href="<?php echo e(route('store-recipe')); ?>" class="bg-teal-500 px-4 py-2 rounded-md hover:bg-teal-400 shadow-md transform hover:scale-105 transition ease-out duration-300 font-nunito font-semibold text-white text-center">Tambah</a>
            </div>
        </div>
    </div>
    <div class="px-4 py-3 mb-3 sm:px-8 md:px-16">
        <div class="flex items-center text-teal-700 text-xl font-semibold font-lora mb-1 py-2">Resep Oleh <?php echo e($user->name); ?></div>
            ...
            <?php $__currentLoopData = $recipe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="relative bg-white rounded-md overflow-hidden shadow-md transform transition hover:scale-105 ease-in duration-200">
                    ...
                    <div>
                        ...
                        <span class="block px-3 pb-3 font-nunito text-md text-gray-600">Oleh <?php echo e(User::where('id', '=', $r->user_id)->value('name')); ?></span>
                    </div>
                    <div class="px-2 py-1 bg-gray-200 font-nunito text-xs uppercase font-semibold rounded-full absolute top-0 m-2">
                        ...
                        <span><?php echo e($r->duration); ?> MENIT</span>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
</div><?php /**PATH E:\masakanku\resources\views/livewire/my-recipe.blade.php ENDPATH**/ ?>