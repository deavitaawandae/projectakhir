            ...
            <ul class="flex items-center">
                <li>
                    <a class="flex items-center" href="<?php echo e(route('home')); ?>">
                        ...
                        <span class="font-bold font-lora italic text-3xl tracking-tight text-teal-700 ml-3 pb-1">Makananku</span>
                    </a>
                </li>
            </ul>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                             <?php $__env->slot('trigger'); ?> 
                                <button class="flex text-sm border-2 border-transparent rounded-full hover:border-teal-500 focus:outline-none focus:border-teal-500 transition duration-150 ease-in-out">
                                    <img class="h-10 w-10 rounded-full" src="<?php echo e(Auth::user()->profile_photo_url); ?>" alt="" />
                                </button>
                             <?php $__env->endSlot(); ?>
...
<?php endif; ?> 
                                 ...
                                 <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.dropdown-link','data' => ['href' => ''.e(route('my-recipe')).'']]); ?>
<?php $component->withName('jet-dropdown-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('my-recipe')).'']); ?>
                                    Resepku
                                 <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
...
<?php endif; ?> 
                ...
                <?php else: ?>
                    <div class="flex items-center">
                        <a href="<?php echo e(route('login')); ?>" class="font-semibold font-nunito border border-teal-600 text-teal-600 rounded-md hover:bg-teal-600 hover:text-white px-5 py-1 transition ease-in duration-300">LOGIN</a>
                    </div>
                <?php endif; ?>
                </div>
            <?php endif; ?>
...
</div><?php /**PATH E:\masakanku\resources\views/livewire/navbar.blade.php ENDPATH**/ ?>